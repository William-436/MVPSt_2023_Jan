...
namespace MVPSt_2023_Jan.Pages
{
    ...
    {
        public void NavigateToDescription(IWebDriver driver)
        {
            // find and click the Description edit icon to open the Description textbox
            Wait.WaitForElementToBeClickable(driver, "XPath", "//*[@id=\"account-profile-section\"]/div/section[2]/div/div/div/div[3]/div/div/div/h3/span/i", 2);
        ...
        public void SetSellersDescription(IWebDriver driver, string NewDesc)
        {
        ...
        public void SetSellersLanguageAndLevel(IWebDriver driver, string Language, string Level)
        {
        ...
        public void SetSellersEducation(IWebDriver driver, string Country, string University, string Title, string Degree, string YearOfGrad)
        {
        ...
        {
            Wait.WaitForElementToExist(driver, "XPath", "//*[@id=\"account-profile-section\"]/div/section[2]/div/div/div/div[3]/form/div[2]/div/div[2]/div/table/tbody[last()]/tr/td[1]", 4);
        ...
        public string GetCountry(IWebDriver driver)
        {
            ...
            Wait.WaitForElementToExist(driver, "XPath", "//*[@id=\"account-profile-section\"]/div/section[2]/div/div/div/div[3]/form/div[4]/div/div[2]/div/table/tbody/tr/td[1]", 4);
            // added [last()] after tbody near end of XPath
        ...
        public string GetYearOfGrad(IWebDriver driver)
        {
            // added [last()] after tbody near end of XPath
        ...
        public void SignOut(IWebDriver driver)
        {
            ...
            Wait.WaitForElementToBeClickable(driver, "XPath", "//*[@id=\"home\"]/div/div/div[1]/div/a", 2);
